...
# for SOC
    for i in arange(N+1):     
        Ham[2*i,2*i] = t2*1j*phas - t2*1j/phas    #(0,0), (2,2), (4,4),...
        Ham[2*i+1,2*i+1] = -t2*1j*phas + t2*1j/phas    #(1,1), (3,3), (5,5),...
        
    for i in arange(int(N/2)):    
        Ham[4*i,4*i+2] = -t2*1j + t2*1j/phas; Ham[4*i+2,4*i] = Ham[4*i,4*i+2].T.conj()   #(0,2), (4,6),...
        Ham[4*i+1,4*i+3] = -t2*1j + t2*1j*phas; Ham[4*i+3,4*i+1] = Ham[4*i+1,4*i+3].T.conj()   #(1,3), (5,7),...
        Ham[4*i+2,4*i+4] = t2*1j - t2*1j*phas; Ham[4*i+4,4*i+2] = Ham[4*i+2,4*i+4].T.conj()   #(2,4), (6,8),...
        Ham[4*i+3,4*i+5] = t2*1j - t2*1j/phas; Ham[4*i+5,4*i+3] = Ham[4*i+3,4*i+5].T.conj()   #(3,5), (7,9),...
